...
public class KhuVucChungActivity extends AppCompatActivity{
    TextView txtView;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(KhuVucChungActivity.this);
                builder.setTitle("Thêm Room");

                // Tạo layout của dialog
                LinearLayout layout = new LinearLayout(KhuVucChungActivity.this);
                layout.setOrientation(LinearLayout.VERTICAL);

                // Tạo EditText để nhập tên Room
                final EditText editTextName = new EditText(KhuVucChungActivity.this);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        new DatabaseHelper.ExecuteAddRoom<String>(new DatabaseCallbackArray<String>() {
                            ...
                            public void onTaskComplete(String result) {
                                if (result != null) {
                                    Toast.makeText(KhuVucChungActivity.this, "Thêm phòng thành công",Toast.LENGTH_SHORT).show();
                                }
                                else {
                                    Toast.makeText(KhuVucChungActivity.this, "Thêm phòng thất bại",Toast.LENGTH_SHORT).show();
                                }
                            }
                        }, KhuVucChungActivity.this, new_room).execute();
                        // Đóng dialog
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(KhuVucChungActivity.this, MarkActivity.class);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this,
            ...
            public void onClick(View view, int position) {
                Intent i = new Intent(KhuVucChungActivity.this, ChamDiemActivity.class);
    ...
    private void getData(Room room){
        ...
        service.execute(new Runnable() {
            ...
            public void run() {
                ...
                }, KhuVucChungActivity.this, room).execute();
